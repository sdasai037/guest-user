    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav mx-auto">
          <li class="nav-item"><!-- mx-auto will center the items -->
            <a class="nav-link" href="index.php">Home</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="womanDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Woman</a>
            <ul class="dropdown-menu" aria-labelledby="womanDropdown">
              <li><a class="dropdown-item" href="woman_shoes.php">Shoes</a></li>
              <li><a class="dropdown-item" href="woman_beg.php">Bag</a></li>
              <li><a class="dropdown-item" href="woman_glass.php">Sunglass</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="manDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Man</a>
            <ul class="dropdown-menu" aria-labelledby="manDropdown">
              <li><a class="dropdown-item" href="man_shoes.php">Shoes</a></li>
              <li><a class="dropdown-item" href="man_cloth.php">cloth</a></li>
              <li><a class="dropdown-item" href="man_wu.php">wuallet</a></li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="search-page.php"></i>Search</a>
          </li>
          <li class="nav-item">
